...
type Config struct {
	...
	VtAddress    string `json:"vt_addr" toml:"vt_addr"`
	VtTabletType string `json:"vt_tablet_type" toml:"vt_tablet_type"`
	VtKeyspace   string `json:"vt_keyspace" toml:"vt_keyspace"`
}
